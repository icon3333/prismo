...
function DropdownMenuLabel({
  ...
  return (
    <MenuPrimitive.GroupLabel
      ...
      data-inset={inset}
      className={cn(
        "px-3 py-2 font-mono text-micro font-medium uppercase tracking-[0.12em] text-ink-2 data-inset:pl-7",
        className
      )}
      {...props}
    />
...
function DropdownMenuSubTrigger({
  ...
  return (
    <MenuPrimitive.SubmenuTrigger
      ...
      data-inset={inset}
      className={cn(
        "flex cursor-pointer items-center gap-1.5 px-3 py-2 text-chrome text-ink outline-none select-none transition-colors duration-[80ms] hover:bg-bg-2 focus:bg-bg-2 data-inset:pl-7 data-popup-open:bg-bg-2 data-open:bg-bg-2 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
        className
      )}
      {...props}
    >
...
function DropdownMenuCheckboxItem({
  ...
  return (
    <MenuPrimitive.CheckboxItem
      ...
      data-inset={inset}
      className={cn(
        "relative flex cursor-pointer items-center gap-1.5 py-2 pr-8 pl-3 text-chrome text-ink outline-none select-none transition-colors duration-[80ms] hover:bg-bg-2 focus:bg-bg-2 data-inset:pl-7 data-disabled:pointer-events-none data-disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
        className
      )}
      checked={checked}
      {...props}
...
function DropdownMenuShortcut({
  ...
  return (
    <span
      ...
      className={cn(
        "ml-auto font-mono text-micro tracking-widest text-ink-3",
        className
      )}
      {...props}
    />
